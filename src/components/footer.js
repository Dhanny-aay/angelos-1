...
const Footer = () => {
    return ( 
        ...
        <div className=' bg-gradient-to-b from-[#751115] to-[#053C2B]'>
            <div className=" w-full pt-8 md:pt-16 px-6 md:px-20 flex flex-row">
                <div className=" pl-3 md:pl-4 pr-3 md:pr-14 border-x-[0.5px] border-[#ffffff8b] text-white">
                ...
                <div className="pl-3 md:pl-4 pr-3 md:pr-14 border-r-[0.5px] border-[#ffffff8b] text-white">
                ...
                <div className="pl-3 md:pl-4 pr-0 md:pr-14 pt-6 w-full space-y-6 text-white">
